...
//These are key parameters used in the Magic Link email sent to users; you'll need to define the product and login / signup URLs, as seen below
const magicLinksView = {
  products: ["emailMagicLinks"],
  emailMagicLinksOptions: {
    loginRedirectURL:
      "http://localhost:3000/api/s-auth/authenticate_magic_link",
...
const LoginWithMagicLinks = ({ styles }) => {
  return (
    <div className="text-center items-center flex flex-col mt-4">
      <h2> Sign up or log in</h2>
      <p>
        {" "}
        Enter your email address to receive an Email Magic Link for
        authentication.
      </p>
      <Stytch
